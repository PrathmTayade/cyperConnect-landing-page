...
Cypher - Modern UI/UX website, developed using React.js and Tailwind CSS, exemplifies modern UI/UX principles. Its sleek design, seamless animations, and overall user experience set a high standard, serving as a reference or inspiration for future modern applications or websites in general.
...
```bash
git clone https://github.com/JavaScript-Mastery-Pro/cypher.git
cd cypher
```
...
export const cypherServices = [
  "Photo generating",
  "Photo enhance",
  "Seamless Integration",
];

export const cypherServicesIcons = [
  recording03,
  recording01,
  disc02,
  chromecast,
...
- [Live Website](https://jsm-cypher.com/)
